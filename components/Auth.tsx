...
import { LogIn, Mail, Lock, UserCircle, Briefcase, Phone } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 border border-slate-100">
        ...
        <div className="mt-8 pt-8 border-t text-center space-y-4">
          ...
          {/* Use casting to any to fix TypeScript "Property 'env' does not exist on type 'ImportMeta'" error in specific environments */}
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6 py-12">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-xl p-8 border border-slate-100">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500">Join our next training session.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 pt-6">
            <button type="submit" className="w-full bg-blue-600 text-white p-4 rounded-xl font-bold shadow-lg hover:bg-blue-700">
              Register Student
            </button>
